...
#######################################################################
    def doAprioriGSPSequenceMining(self,maxlength=5):
        ...
        self.candidates.append(['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p',
        ...
        s = sorted(list(candidate_support.items()),
...
if __name__ == "__main__":
    s = SequenceMining()
    s.doAprioriGSPSequenceMining(maxlength=4)
