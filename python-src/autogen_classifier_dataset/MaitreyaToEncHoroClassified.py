...
#Reads the segregated parsed dataset files generated by asfer_dataset_aggregator.sh and invokes maitreya_textclient
#for all date-time-long-lat data within all parsed datasets for a particular event class - "EventClassDataset_<class>.txt"
...
def writeToEncHorosAscRelative(cl):
	enchoro=open("./asfer.enchoros."+cl+".zodiacal","r")
	enchoroasc=open("./asfer.enchoros."+cl+".ascrelative", "a")
	for line in enchoro:
...
def writeToEncHoros(bhavaplanetsdict,cl):
	enchoro=open("./asfer.enchoros."+cl+".zodiacal","a")
	#if AscRelative:
...
for cl in classes:
	f=open("EventClassDataSet_"+cl+".txt","r")
	for n in f:
		classdatasetfilenames[cl]=classdatasetfilenames[cl]+[n]

#datasetfile=open("/home/kashrinivaasan/KrishnaiResearch_OpenSource/asfer-code/cpp-src/earthquakesFrom1900with8plusmag.txt","r")
#datasetfile=open("./earthquakesFrom1900with8plusmag.txt","r")
	for datasetfilename in classdatasetfilenames[cl]:
		...
		for line in datasetfile:
			...
			writeToEncHoros(bhavaplanetsdict,cl)
			#writeToEncHorosAscRelative(cl)
			bhavaplanetsdict={}
			bhavaplanetsdict["Aries"]=[]
			bhavaplanetsdict["Taurus"]=[]
			bhavaplanetsdict["Gemini"]=[]
