...
class VowellessText:
	def __init__(self):
		...
		for k1,v1 in self.Probabilities_prefixes.items():
			if maxv1 < v1:
				maxv1 = v1
				maxk1 = k1	
				#maxvowel = maxk1[len(maxk1)-1]

		for k2,v2 in self.Probabilities_suffixes.items():
			if maxv2 < v2:
				maxv2 = v2
				maxk2 = k2 
...
#
	...
	def HiddenMarkovModel_MLE(self,comp):
		...
		self.matchinglikelydict = WordSubstringProbabilities.wordlikelydict(comp)
		...
		maxlikelyret=""	
		for k7, v7 in self.matchinglikelydict.items():
...
if __name__=="__main__":	
	...
	for i in fcompstr.split():
		...
		#maximumlikelihoodword=vowellesstxt.compute_maximumlikelihood(i,suggestions)	
		maximumlikelihoodword=vowellesstxt.compute_maximumlikelihood(i)
