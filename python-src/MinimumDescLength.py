...
def minimum_descriptive_complexity(string):
	compstr=zlib.compress(string)
	print "String Length = " + str(len(string))
	print "Minimum Description Length with Zlib compression = " + str(len(compstr))
	print "Compression Ratio with Zlib compression = " + str(float(len(compstr))/float(len(string)))
	...
	print "Compression Ratio with vowel compression = " + str(float(len(stripvow))/float(len(string)))  
