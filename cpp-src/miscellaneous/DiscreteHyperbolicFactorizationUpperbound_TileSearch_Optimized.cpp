...
int main(int argc, char *argv[])
{
	...
	tileintervalsf = fopen("./DiscreteHyperbolicFactorizationUpperbound_TileSearch_Optimized.tileintervals","w+");
...
int create_tiles(int N, int xleft, int yleft, int xright, int yright)
{
	...
	{
		fprintf(tileintervalsf,"(%d,%d,%d,%d)\n",xleft,yleft,xright,yright);
	}
}
